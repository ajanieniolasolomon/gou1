...
function getEmit(rawFilePath, filePath, instance, loader) {
    ...
    var outputFile = outputFiles.filter(function (outputFile) { return outputFile.name.match(constants.jsJsx); }).pop();
    var outputText = (outputFile) ? outputFile.text : undefined;
    var sourceMapFile = outputFiles.filter(function (outputFile) { return outputFile.name.match(constants.jsJsxMap); }).pop();
...
function getTranspilationEmit(filePath, contents, instance, loader) {
    ...
    if (!instance.loaderOptions.happyPackMode) {
        utils_1.registerWebpackErrors(loader._module.errors, utils_1.formatErrors(diagnostics, instance.loaderOptions, instance.colors, instance.compiler, { module: loader._module }, loader.context));
    }
    return { outputText: outputText, sourceMapText: sourceMapText };
}
